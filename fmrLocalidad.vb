Public Class fmrLocalidad
    ...
    Private Sub Grillalocalidad_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles Grillalocalidad.CellDoubleClick
        ...
        If lblseñallocalidad.Text = "Agenda" Then
            FmrAbmAgenda.txtlocalidadagendaabm.Text = Grillalocalidad.CurrentRow.Cells(0).Value
            FmrAbmAgenda.txtlocalidadagendanombreabm.Text = Grillalocalidad.CurrentRow.Cells(1).Value

            Close()

        End If
        If lblseñallocalidad.Text = "Paciente" Then
            FmrabmPaciente.txtlocalidad.Text = Grillalocalidad.CurrentRow.Cells(0).Value
            FmrabmPaciente.txtlocalidadnombre.Text = Grillalocalidad.CurrentRow.Cells(1).Value
            Close()
