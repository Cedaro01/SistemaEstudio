Public Class Fmrprincipal
    ...
    Private Sub Fmrprincipal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            conexionSql.ConnectionString = "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=SistemaEstudiosMedicos;Data Source=CESARPC\SQLEXPRESS;Multipleactiveresultsets=true"
