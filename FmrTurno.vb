Public Class FmrTurno
    ...
    Public Sub CargaTurno()
        ...
        'llama a la funcion de carga de registros de Paciente
    ...
    Private Sub Cmdeliminar_Click(sender As Object, e As EventArgs) Handles Cmdeliminar.Click
        ...
        If result = DialogResult.Yes Then
            ...
            'llama a la funcion de carga de paciente para refrescar la grilla
            CargaTurno()
    ...
    Private Sub Cmdbuscarconsulta_Click(sender As Object, e As EventArgs) Handles Cmdbuscarconsulta.Click
        ...
        'llama a la funcion de carga de registros de pacientes
